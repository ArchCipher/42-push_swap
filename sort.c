...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/06 18:45:52 by kmurugan          #+#    #+#             */
/*   Updated: 2025/11/06 18:54:23 by kmurugan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
DESCRIPTION
	It sorts a stack of 3 elements in ascending order.
*/
...
/*
DESCRIPTION
	It sorts a stack of more than 3 elements in ascending order.
*/
...
/*
DESCRIPTION
	It sets a target node for all nodes in source. If src is a, the target node
    is the closest smaller number in dst (b), or the biggest number in dst in
    case of no smaller number. If src is b, the target node is the closest larger
    number in dst (a), or the smallest number in dst in case of no bigger number.
*/
...
/*
DESCRIPTION
	If source is a, it finds the closest smaller number.
	If source is b, it finds the closest larger number.
*/
...
DESCRIPTION
	...
	Above median, the cost is the value of its index.
    Below median, the cost is the value of stack_len - index.
*/
